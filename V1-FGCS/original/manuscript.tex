...
\begin{itemize}
	...
	\item Arquitectura en microservicios (e.g., \href{https://github.com/instana/robot-shop}{Instana Robot Shop} + \href{https://locust.io/}{Locust}, Flask + Locust), en este caso no se procesarán datos per se, sino peticiones, que se pueden aumentar o disminuir en intensidad.
	...
	\item Procesado de eventos (e.g., clickstream \href{https://github.com/ClickHouse/ClickBench}{ClickBench}, mensajes)
	
	\item Procesado de métricas, sensores (e.g., \href{https://github.com/timescale/tsbs}{Time Series Benchmark Suite (TSBS)})
	
	\item Reconocimiento facial (e.g., \href{http://vis-www.cs.umass.edu/lfw/}{Faces in the Wild}), en este caso los datos son las caras.
	
	\item Encriptado/Cifrado/Hashing de ficheros.
